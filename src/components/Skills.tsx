...
const additionalSkills = [
  { icon: MessageSquare, label: "Communication & Teamwork" },
  { icon: Brain, label: "Leadership & Coordination" },
  { icon: Code2, label: "Open-source Contribution" },
  { icon: Globe, label: "English, Hindi, Kannada, Tulu" },
];
